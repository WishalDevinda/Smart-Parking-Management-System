...
const ReservationPortal = () => {
  ...
  const [warnings, setWarnings] = useState({ contactNumber: '' });
  const [errors, setErrors] = useState({ vehicleNumber: '' });
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'contactNumber') {
      ...
      if (digits.length > 10) {
        setWarnings(prev => ({ ...prev, contactNumber: 'Contact number should not exceed 10 digits.' }));
      } else {
    ...
    if (name === 'vehicleNumber') {
      const pattern = /^([A-Z]{3}|[A-Z]{2}|[0-9]{3})-[0-9]{4}$/i;
      if (value && !pattern.test(value.trim())) {
        setErrors(prev => ({ ...prev, vehicleNumber: 'Format must be ABC-1234, AA-1234, or 123-1234.' }));
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate vehicle number before submit
    const vehiclePattern = /^([A-Z]{3}|[A-Z]{2}|[0-9]{3})-[0-9]{4}$/i;
    if (formData.vehicleNumber && !vehiclePattern.test(formData.vehicleNumber.trim())) {
      setErrors(prev => ({ ...prev, vehicleNumber: 'Format must be ABC-1234, AA-1234, or 123-1234.' }));
      setLoading(false);
      return;
    }
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              />
              {warnings.contactNumber && (
                <small style={{ color: colors.orange, display: 'block', marginTop: '0.4rem' }}>
                  {warnings.contactNumber}
                </small>
              )}
            </div>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              {errors.vehicleNumber && (
                <small style={{ color: colors.red, display: 'block', marginTop: '0.4rem' }}>
                  {errors.vehicleNumber}
                </small>
              )}
            </div>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              >
                ...
                <option value="Moter-Bicycle">Moter-Bicycle</option>
